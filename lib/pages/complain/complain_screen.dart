...
class _ComplainScreenState extends State<ComplainScreen> {
  ...
  void initState() {
    // TODO: implement initState
     thanaValue = list.first;
     complainValue = list1.first;
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ComplainController>(builder: (complain){
        return  SafeArea(
                  ...
                  onTap: (){
                    setState(() {
                      if(_commentController.text.isNotEmpty){
                        ...
                        //TODO send the data to complain repo
                        complain.createComplain(thanaValue, complainValue, _commentController.text).then((value){
